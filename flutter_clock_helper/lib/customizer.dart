...
class _ClockCustomizerState extends State<ClockCustomizer> {
            ...
            child: Column(
              children: <Widget>[
                ...
                _switch('24-hour format', _model.is24HourFormat, (bool value) {
                  setState(() {
                    _model.is24HourFormat = value;
                     _timeMarker = DateFormat('a').format(DateTime.now());
                ...
                _enumMenu(
                  ...
                  setState(() {
                    String weatherType = enumToString(condition);
                    _model.weatherCondition = condition;
                    _weatherIcon = kWeatherIcons[weatherType];
                  });
                }),
  ...
  Widget build(BuildContext context) {
    ...
    _weatherIcon = kWeatherIcons[enumToString(_model.weatherCondition)];
               ...
               if (!_model.is24HourFormat)
                  Positioned(
                    ...
                    child: Padding(
                      padding: EdgeInsets.all(10.0),
                      child: Icon(
                        _timeMarker =='AM' ? Icons.wb_sunny : Icons.brightness_3
                      ),
                    ),
                  ) 
              ],
